...
export function transformedBoxGeometry(
  ...
  const valid = [
    appendFace(geometry, [bottom00, bottom01, bottom11, bottom10]),
    appendFace(geometry, [top00, top10, top11, top01]),
    appendFace(geometry, [bottom00, top00, top01, bottom01]),
    appendFace(geometry, [bottom10, bottom11, top11, top10]),
    appendFace(geometry, [bottom00, bottom10, top10, top00]),
    appendFace(geometry, [bottom01, top01, top11, bottom11]),
  ].every(Boolean);
